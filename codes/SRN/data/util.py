...
if __name__ == '__main__':
    ...
    # # read images
    # img = cv2.imread('/media/4T/Dizzy/SR_classical_DataSet/NTIRE2019/Ori_datasets/ValidationLR/cam1_01.png')
    # img = img * 1.0 / 255
    ...
    # read images
    import torchvision.utils
    imgpath = '/media/4T/Dizzy/AIM/0316_test_imgs/test_imgs/'
    savepath = '/media/4T/Dizzy/AIM/0316_test_imgs/test_imgs_4xup/'
