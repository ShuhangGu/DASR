...
if __name__ == '__main__':
    ...
    model_path = '/media/4T/Dizzy/BasicSR-master/Final_models/New/ESRGAN/Final_models/AIM/Complete_LPIPS0.337_205000_G.pth'
    # location of pre-trained model
    # model = De_Resnet().cuda()
    model = RRDBNet().cuda()
    model.load_state_dict(torch.load(model_path))

    img = np.array(Image.open('/media/4T/Dizzy/AIM/AIM_datasets/ValidationSource/0801.png'))/255
